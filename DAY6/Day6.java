...
public class Day6 
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("Saisukirtha");
		...
		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("saisukirtha@2003");
		...
		driver.findElement(By.xpath("//*[@id=\"first_name\"]")).sendKeys("Saisukirtha");
		driver.findElement(By.xpath("//*[@id=\"last_name\"]")).sendKeys("S");
		driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("sai@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"radio_1665627729_Male\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).sendKeys("saisukirtha@2003");
